...
WebUI.callTestCase(findTestCase('Execution/IMONE CASINO/IM Gaming/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_Casino/IM_Gaming').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_Casino/IM_Gaming').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
