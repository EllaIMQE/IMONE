...
WebUI.callTestCase(findTestCase('Execution/IMONE CASINO/IM Gaming/NewLaunchGame'), [:], FailureHandling.STOP_ON_FAILURE)

response = WS.sendRequest(findTestObject('Execution/IMONE CASINO/IM Gaming/Player_GetBalance'))
