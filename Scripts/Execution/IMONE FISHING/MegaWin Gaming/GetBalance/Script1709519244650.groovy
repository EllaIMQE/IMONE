...
WebUI.callTestCase(findTestCase('Execution/IMONE FISHING/MegaWin Gaming/NewLaunchGame'), [:], FailureHandling.STOP_ON_FAILURE)

response = WS.sendRequest(findTestObject('Execution/IMONE FISHING/Mega Win Gaming/Player_GetBalance'))
