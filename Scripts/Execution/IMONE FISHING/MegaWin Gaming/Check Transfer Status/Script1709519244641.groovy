...
WebUI.callTestCase(findTestCase('Execution/IMONE FISHING/MegaWin Gaming/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.Register_PlayerID, ('ProductWallet') : findTestData('IMONE/IM_Fishing/Mega_Win').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_Fishing/Mega_Win').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
