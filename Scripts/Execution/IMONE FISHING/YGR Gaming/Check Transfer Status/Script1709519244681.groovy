...
WebUI.callTestCase(findTestCase('Execution/IMONE FISHING/YGR Gaming/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_Fishing/YGR').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_Fishing/YGR').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
