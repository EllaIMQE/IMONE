...
WebUI.callTestCase(findTestCase('Execution/IMONE FISHING/YGR Gaming/NewLaunchGame'), [:], FailureHandling.STOP_ON_FAILURE)

response = WS.sendRequest(findTestObject('Execution/IMONE FISHING/YGR Gaming/Player_GetBalance'))
