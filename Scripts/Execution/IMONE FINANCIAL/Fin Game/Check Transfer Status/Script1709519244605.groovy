...
WebUI.callTestCase(findTestCase('Execution/IMONE FINANCIAL/Fin Game/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_Financial/Fin_Game').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_Financial/Fin_Game').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
