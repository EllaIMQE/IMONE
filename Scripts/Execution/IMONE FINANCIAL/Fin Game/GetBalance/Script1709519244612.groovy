...
WebUI.callTestCase(findTestCase('Execution/IMONE FINANCIAL/Fin Game/NewLaunchGame'), [:], FailureHandling.STOP_ON_FAILURE)

response = WS.sendRequest(findTestObject('Execution/IMONE FINANCIAL/Fin Game/Player_GetBalance'))
