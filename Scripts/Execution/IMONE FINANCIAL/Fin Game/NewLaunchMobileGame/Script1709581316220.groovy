 ...
 */
response = WS.sendRequest(findTestObject('Execution/IMONE FINANCIAL/Fin Game/Game_NewLaunchMobileGame'))
...
WebUI.enhancedClick(findTestObject('Execution/IMONE FINANCIAL/Fin Game/Page_/btn_Next'))

WebUI.delay(5)

WebUI.enhancedClick(findTestObject('Execution/IMONE FINANCIAL/Fin Game/Page_/btn_Skip'))
