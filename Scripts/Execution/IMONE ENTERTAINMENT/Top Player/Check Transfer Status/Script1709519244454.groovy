...
WebUI.callTestCase(findTestCase('Execution/IMONE ENTERTAINMENT/Top Player/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_Entertainment/Top_Player').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_Entertainment/Top_Player').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
