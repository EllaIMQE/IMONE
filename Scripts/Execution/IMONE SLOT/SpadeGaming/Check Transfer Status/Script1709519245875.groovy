...
WebUI.callTestCase(findTestCase('Execution/IMONE SLOT/SpadeGaming/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_Slot/Spade').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_Slot/Spade').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
