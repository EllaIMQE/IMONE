...
response = WS.sendRequest(findTestObject('Execution/IMONE SLOT/SpadeGaming/Player_GetBalance'))
...
WebUI.verifyElementPresent(findTestObject('Execution/IMONE SLOT/SpadeGaming/Adventure Iceland/balance'), 0)
