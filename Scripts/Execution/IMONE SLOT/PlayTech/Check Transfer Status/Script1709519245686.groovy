...
WebUI.callTestCase(findTestCase('Execution/IMONE SLOT/PlayTech/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode_Playtech
        , ('PlayerId') : GlobalVariable.PlayerId_Playtech, ('ProductWallet') : findTestData('IMONE/IM_Slot/Playtech').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_Slot/Playtech').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
