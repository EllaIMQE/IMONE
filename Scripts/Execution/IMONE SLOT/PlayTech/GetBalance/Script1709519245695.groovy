...
WebUI.callTestCase(findTestCase('Execution/IMONE SLOT/PlayTech/NewLaunchGame'), [:], FailureHandling.STOP_ON_FAILURE)

response = WS.sendRequest(findTestObject('Execution/IMONE SLOT/PlayTech/Player_GetBalance'))
