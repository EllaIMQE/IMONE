...
WebUI.callTestCase(findTestCase('Execution/IMONE SLOT/MicroGaming/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_Slot/MicroGaming').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_Slot/MicroGaming').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
