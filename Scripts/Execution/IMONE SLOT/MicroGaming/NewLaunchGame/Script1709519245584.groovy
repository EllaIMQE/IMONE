...
response = WS.sendRequest(findTestObject('Execution/IMONE SLOT/MicroGaming/Game_NewLaunchGame'))
...
WebUI.enhancedClick(findTestObject('Execution/IMONE SLOT/MicroGaming/canvas'), FailureHandling.CONTINUE_ON_FAILURE)
