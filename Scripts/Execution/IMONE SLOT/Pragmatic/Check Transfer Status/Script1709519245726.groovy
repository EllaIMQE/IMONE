...
WebUI.callTestCase(findTestCase('Execution/IMONE SLOT/Pragmatic/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_Slot/Pragmatic').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_Slot/Pragmatic').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
