...
WebUI.callTestCase(findTestCase('Execution/IMONE SLOT/Skywind/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_Slot/Skywind').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_Slot/Skywind').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
