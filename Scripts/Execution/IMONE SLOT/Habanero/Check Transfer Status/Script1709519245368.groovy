...
WebUI.callTestCase(findTestCase('Execution/IMONE SLOT/Habanero/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_Slot/Habanero').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_Slot/Habanero').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
