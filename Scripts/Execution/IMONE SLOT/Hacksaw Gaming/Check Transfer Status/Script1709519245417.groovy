...
WebUI.callTestCase(findTestCase('Execution/IMONE SLOT/Hacksaw Gaming/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_Slot/Hacksaw').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_Slot/Hacksaw').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
