...
WebUI.callTestCase(findTestCase('Execution/IMONE SLOT/Spribe/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_SLOT/Spribe').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_SLOT/Spribe').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
