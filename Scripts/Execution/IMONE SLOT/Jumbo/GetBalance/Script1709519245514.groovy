...
response = WS.sendRequest(findTestObject('Execution/IMONE SLOT/Jumbo/Player_GetBalance', [('baseUrl') : GlobalVariable.baseUrl
            , ('MerchantCode') : GlobalVariable.MerchantCode, ('PlayerId') : GlobalVariable.PlayerId, ('GameCode') : 'imgame27015'
            , ('LANGUAGE') : findTestData('IMONE/IM_Slot/Jumbo').getValue(8, 1), ('ProductWallet') : findTestData('IMONE/IM_Slot/Jumbo').getValue(
                3, 1), ('Currency') : findTestData('IMONE/IM_Slot/Jumbo').getValue(6, 1)]))
...
WebUI.verifyElementPresent(findTestObject('Execution/IMONE SLOT/Jumbo/Napoleon - JDB/credit'), 0, FailureHandling.CONTINUE_ON_FAILURE)
