...
WebUI.callTestCase(findTestCase('Execution/IMONE SLOT/Jumbo/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_Slot/Jumbo').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_Slot/Jumbo').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
