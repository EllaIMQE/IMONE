 ...
 */
response = WS.sendRequest(findTestObject('Execution/IMONE SLOT/Advant Play/Game_NewLaunchMobileGame'))
...
WebUI.enhancedClick(findTestObject('Execution/IMONE SLOT/Advant Play/Bunny to the Moon/canvas'), FailureHandling.CONTINUE_ON_FAILURE)
