...
WebUI.callTestCase(findTestCase('Execution/IMONE SLOT/Advant Play/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_Slot/Advant_Play').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_Slot/Advant_Play').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
