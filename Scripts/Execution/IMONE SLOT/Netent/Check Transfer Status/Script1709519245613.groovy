...
WebUI.callTestCase(findTestCase('Execution/IMONE SLOT/Netent/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_Slot/Netent').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_Slot/Netent').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
