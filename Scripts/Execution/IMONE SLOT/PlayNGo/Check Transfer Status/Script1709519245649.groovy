...
WebUI.callTestCase(findTestCase('Execution/IMONE SLOT/PlayNGo/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_Slot/PlayNGo').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_Slot/PlayNGo').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
