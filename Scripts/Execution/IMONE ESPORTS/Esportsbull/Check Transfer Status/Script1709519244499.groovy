...
WebUI.callTestCase(findTestCase('Execution/IMONE ESPORTS/Esportsbull/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_Esports/Esportsbull').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_Esports/Esportsbull').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
