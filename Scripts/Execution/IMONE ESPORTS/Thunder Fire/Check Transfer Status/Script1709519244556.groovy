...
WebUI.callTestCase(findTestCase('Execution/IMONE ESPORTS/Thunder Fire/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_Esports/Thunder_Fire').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_Esports/Thunder_Fire').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
