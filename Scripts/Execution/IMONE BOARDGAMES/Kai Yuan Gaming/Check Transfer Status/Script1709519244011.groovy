...
WebUI.callTestCase(findTestCase('Execution/IMONE BOARDGAMES/Kai Yuan Gaming/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_BoardGames/Kai_Yuan').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_BoardGames/Kai_Yuan').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
