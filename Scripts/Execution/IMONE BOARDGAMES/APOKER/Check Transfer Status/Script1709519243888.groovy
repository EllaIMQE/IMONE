...
WebUI.callTestCase(findTestCase('Execution/IMONE BOARDGAMES/APOKER/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_BoardGames/Apoker').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_BoardGames/Apoker').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
