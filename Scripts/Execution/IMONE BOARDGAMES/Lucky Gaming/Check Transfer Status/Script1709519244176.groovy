...
WebUI.callTestCase(findTestCase('Execution/IMONE BOARDGAMES/Lucky Gaming/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_BoardGames/Lucky').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_BoardGames/Lucky').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
