...
WebUI.callTestCase(findTestCase('Execution/IMONE BOARDGAMES/BOLE Gaming/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_BoardGames/BOLE').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_BoardGames/BOLE').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
