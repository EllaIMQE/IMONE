...
WebUI.callTestCase(findTestCase('Execution/IMONE BOARDGAMES/IM Gaming/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_BoardGames/IM_Gaming').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_BoardGames/IM_Gaming').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
