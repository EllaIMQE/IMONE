...
WebUI.callTestCase(findTestCase('Execution/IMONE BOARDGAMES/Yan You Gaming/NewLaunchGame'), [:], FailureHandling.STOP_ON_FAILURE)

response = WS.sendRequest(findTestObject('Execution/IMONE BOARDGAMES/Yan You Gaming/Player_GetBalance'))
