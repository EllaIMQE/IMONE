...
WebUI.callTestCase(findTestCase('Execution/IMONE BOARDGAMES/Yan You Gaming/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_BoardGames/Yan_You').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_BoardGames/Yan_You').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
