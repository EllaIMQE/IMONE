...
WebUI.callTestCase(findTestCase('Execution/IMONE BOARDGAMES/SG Win Gaming/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_BoardGames/SG_Win').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_BoardGames/SG_Win').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
