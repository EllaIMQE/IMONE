...
WebUI.callTestCase(findTestCase('Execution/IMONE BOARDGAMES/Tianyou Gaming/NewLaunchGame'), [:], FailureHandling.STOP_ON_FAILURE)

response = WS.sendRequest(findTestObject('Execution/IMONE BOARDGAMES/Tianyou Gaming/Player_GetBalance'))
