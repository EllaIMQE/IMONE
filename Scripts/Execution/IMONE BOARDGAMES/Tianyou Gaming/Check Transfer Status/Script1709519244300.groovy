...
WebUI.callTestCase(findTestCase('Execution/IMONE BOARDGAMES/Tianyou Gaming/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_BoardGames/Tianyou').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_BoardGames/Tianyou').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
