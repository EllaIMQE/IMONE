...
WebUI.callTestCase(findTestCase('Execution/IMONE BOARDGAMES/Meitian Gaming/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_BoardGames/Meitian').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_BoardGames/Meitian').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
