...
WebUI.callTestCase(findTestCase('Execution/IMONE BOARDGAMES/King Maker/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_BoardGames/King_Maker').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_BoardGames/King_Maker').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
