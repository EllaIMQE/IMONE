...
WebUI.callTestCase(findTestCase('Execution/IMONE LIVE DEALER/Asia Gaming/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_LiveDealer/Asia_Gaming').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_LiveDealer/Asia_Gaming').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
