...
WebUI.callTestCase(findTestCase('Execution/IMONE LIVE DEALER/World Entertainment (EBET)/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_LiveDealer/World_Ent_EBET').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_LiveDealer/World_Ent_EBET').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
