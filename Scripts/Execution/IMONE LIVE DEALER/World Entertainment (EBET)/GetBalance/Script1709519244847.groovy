...
WebUI.callTestCase(findTestCase('Execution/IMONE LIVE DEALER/World Entertainment (EBET)/NewLaunchGame'), [:], FailureHandling.STOP_ON_FAILURE)

response = WS.sendRequestAndVerify(findTestObject('Execution/IMONE LIVE DEALER/World Entertainment (EBET)/Player_GetBalance'))
