...
WebUI.callTestCase(findTestCase('Execution/IMONE LIVE DEALER/Pragmatic Play LD/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_LiveDealer/Pragmatic_Play_LD').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_LiveDealer/Pragmatic_Play_LD').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
