...
WebUI.callTestCase(findTestCase('Execution/IMONE LOTTERY/IG Lottery/NewLaunchGame'), [:], FailureHandling.STOP_ON_FAILURE)

response = WS.sendRequestAndVerify(findTestObject('Execution/IMONE LOTTERY/IG Lottery/Player_GetBalance'))
