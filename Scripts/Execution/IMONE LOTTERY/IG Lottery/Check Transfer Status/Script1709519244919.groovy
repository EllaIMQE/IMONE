...
WebUI.callTestCase(findTestCase('Execution/IMONE LOTTERY/IG Lottery/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_Lottery/IG_Lottery').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_Lottery/IG_Lottery').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
