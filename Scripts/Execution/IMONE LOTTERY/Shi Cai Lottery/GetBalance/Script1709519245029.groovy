...
WebUI.callTestCase(findTestCase('Execution/IMONE LOTTERY/Shi Cai Lottery/NewLaunchGame'), [:], FailureHandling.STOP_ON_FAILURE)

response = WS.sendRequest(findTestObject('Execution/IMONE LOTTERY/Shi Cai Lottery/Player_GetBalance'))
...
bd = bd.setScale(4, BigDecimal.ROUND_FLOOR)
...
WebUI.verifyTextPresent(balanceText, false)
