...
WebUI.callTestCase(findTestCase('Execution/IMONE LOTTERY/Shi Cai Lottery/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_Lottery/Shi_Cai').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_Lottery/Shi_Cai').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
