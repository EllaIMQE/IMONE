...
WebUI.callTestCase(findTestCase('Execution/IMONE LOTTERY/VR Lottery/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_Lottery/VR_Lottery').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_Lottery/VR_Lottery').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
