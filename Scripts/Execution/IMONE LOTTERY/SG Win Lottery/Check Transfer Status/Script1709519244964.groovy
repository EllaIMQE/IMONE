...
WebUI.callTestCase(findTestCase('Execution/IMONE LOTTERY/SG Win Lottery/Perform Transfer'), [('MerchantCode') : GlobalVariable.MerchantCode
        , ('PlayerId') : GlobalVariable.PlayerId, ('ProductWallet') : findTestData('IMONE/IM_Lottery/SG_Win').getValue(3, 1)
        , ('Amount') : findTestData('IMONE/IM_Lottery/SG_Win').getValue(9, 1), ('transactionId') : GlobalVariable.generatedTransactionId], 
