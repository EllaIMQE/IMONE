...
WebUI.callTestCase(findTestCase('Execution/IMONE LOTTERY/SG Win Lottery/NewLaunchGame'), [:], FailureHandling.STOP_ON_FAILURE)

response = WS.sendRequestAndVerify(findTestObject('Execution/IMONE LOTTERY/SG Win Lottery/Player_GetBalance'))
