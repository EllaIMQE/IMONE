...
def testData = findTestData('IMONE/IM_Slot/Spribe')
...
for (int i = 1; i <= rowCount; i++) {
    ...
    response = WS.sendRequest(findTestObject('Execution/Execution Loop/SLOT Loop/Spribe/Game_NewLaunchMobileGame', [('baseUrl') : GlobalVariable.baseUrl
