...
def testData = findTestData('IMONE/IM_Slot/Jumbo')
...
for (int i = 1; i <= rowCount; i++) {
    ...
    response = WS.sendRequest(findTestObject('Execution/Execution Loop/SLOT Loop/Jumbo/Game_NewLaunchMobileGame', [('baseUrl') : GlobalVariable.baseUrl
