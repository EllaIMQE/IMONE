...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>cb83f3b1-be64-44b9-b55e-c6414011c9ba</elementGuidId>
  ...
  &quot;charset&quot;: &quot;UTF-8&quot;
   ...
   <variables>
      <defaultValue>GlobalVariable.MerchantCode_SB</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>'IMSB'</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_SportsBook/SportsBook').getValue(8, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_SportsBook/SportsBook').getValue(3, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_SportsBook/SportsBook').getValue(6, 1)</defaultValue>
      <description></description>
