...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>f5afb40d-5fb8-4f53-b6d3-9c70d988d437</elementGuidId>
  ...
  &quot;charset&quot;: &quot;UTF-8&quot;
   ...
   <variables>
      <defaultValue>'imlive04005'</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_LiveDealer/Big_Gaming').getValue(8, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_LiveDealer/Big_Gaming').getValue(3, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_LiveDealer/Big_Gaming').getValue(6, 1)</defaultValue>
      <description></description>
