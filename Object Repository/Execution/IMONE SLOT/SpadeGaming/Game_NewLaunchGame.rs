...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>81f820d1-f516-426d-8210-fb710bfe2aff</elementGuidId>
  ...
  &quot;charset&quot;: &quot;UTF-8&quot;
   ...
   <variables>
      <defaultValue>'imgame16002'</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Slot/Spade').getValue(8, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Slot/Spade').getValue(3, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Slot/Spade').getValue(6, 1)</defaultValue>
      <description></description>
