...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>c7fe3450-1d34-467d-b6ef-4b98d157d2a1</elementGuidId>
  ...
  &quot;charset&quot;: &quot;UTF-8&quot;
   ...
   <variables>
      <defaultValue>'imgame12009'</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Slot/Spribe').getValue(8, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Slot/Spribe').getValue(3, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Slot/Spribe').getValue(6, 1)</defaultValue>
      <description></description>
