...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>c13a8d7a-e9af-436b-8446-2e5b958cfce1</elementGuidId>
  ...
  &quot;charset&quot;: &quot;UTF-8&quot;
   ...
   <variables>
      <defaultValue>'imgame13126'</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Slot/Pragmatic').getValue(8, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Slot/Pragmatic').getValue(3, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Slot/Pragmatic').getValue(6, 1)</defaultValue>
      <description></description>
