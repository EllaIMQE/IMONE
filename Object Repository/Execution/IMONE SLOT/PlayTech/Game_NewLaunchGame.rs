...
<WebServiceRequestEntity>
   ...
   <name>Game_NewLaunchGame</name>
   <tag></tag>
   <elementGuidId>48dc5dfd-93eb-4645-b5c3-fe9ffb586686</elementGuidId>
  ...
  &quot;charset&quot;: &quot;UTF-8&quot;
   ...
   <restUrl>${baseUrl}/Game/NewLaunchGame</restUrl>
   ...
   <variables>
      <defaultValue>GlobalVariable.MerchantCode_Playtech</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>GlobalVariable.PlayerId_Playtech</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>'tpd2'</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Slot/Playtech').getValue(8, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Slot/Playtech').getValue(3, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Slot/Playtech').getValue(6, 1)</defaultValue>
      <description></description>
