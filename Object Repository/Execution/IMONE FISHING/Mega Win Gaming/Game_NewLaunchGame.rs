...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>b96df07d-3b48-41e2-bd12-c5fe0b4da464</elementGuidId>
  ...
  &quot;charset&quot;: &quot;UTF-8&quot;
   ...
   <variables>
      <defaultValue>'imfishingH5100084'</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Fishing/Mega_Win').getValue(8, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Fishing/Mega_Win').getValue(3, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Fishing/Mega_Win').getValue(6, 1)</defaultValue>
      <description></description>
