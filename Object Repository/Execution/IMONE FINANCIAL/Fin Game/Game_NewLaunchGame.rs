...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>a0d4c3c1-e1a1-4b6d-bf39-86854a0e076f</elementGuidId>
  ...
  &quot;charset&quot;: &quot;UTF-8&quot;
   ...
   <variables>
      <defaultValue>'IMFG0002'</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Financial/Fin_Game').getValue(8, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Financial/Fin_Game').getValue(3, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Financial/Fin_Game').getValue(6, 1)</defaultValue>
      <description></description>
