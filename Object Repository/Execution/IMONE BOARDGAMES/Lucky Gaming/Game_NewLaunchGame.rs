...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>2ecd7390-a373-4fc9-bf3e-560df28b4c00</elementGuidId>
  ...
  &quot;charset&quot;: &quot;UTF-8&quot;
   ...
   <variables>
      <defaultValue>'IMBG70000'</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_BoardGames/Lucky').getValue(8, 2)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_BoardGames/Lucky').getValue(3, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_BoardGames/Lucky').getValue(6, 1)</defaultValue>
      <description></description>
