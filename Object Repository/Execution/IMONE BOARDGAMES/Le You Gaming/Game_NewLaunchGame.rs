...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>6ac4a892-0ad0-424c-b6b4-d9dda03c485d</elementGuidId>
  ...
  &quot;charset&quot;: &quot;UTF-8&quot;
   ...
   <variables>
      <defaultValue>'IMBG10039'</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_BoardGames/Le_You').getValue(8, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_BoardGames/Le_You').getValue(3, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_BoardGames/Le_You').getValue(6, 1)</defaultValue>
      <description></description>
