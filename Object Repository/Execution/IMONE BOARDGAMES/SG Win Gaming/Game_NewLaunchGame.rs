...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>4e4bec1b-b534-48b9-a2a1-158e270ee451</elementGuidId>
  ...
  &quot;charset&quot;: &quot;UTF-8&quot;
   ...
   <variables>
      <defaultValue>'IMBG60006'</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_BoardGames/SG_Win').getValue(8, 2)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_BoardGames/SG_Win').getValue(3, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_BoardGames/SG_Win').getValue(6, 1)</defaultValue>
      <description></description>
