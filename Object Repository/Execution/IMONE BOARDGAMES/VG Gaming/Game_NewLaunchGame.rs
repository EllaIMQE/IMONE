...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>acce1988-d40a-43a2-8e69-f5bc6c9cbaf7</elementGuidId>
  ...
  &quot;charset&quot;: &quot;UTF-8&quot;
   ...
   <variables>
      <defaultValue>'IMBG30003'</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_BoardGames/VG_Gaming').getValue(8, 2)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_BoardGames/VG_Gaming').getValue(3, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_BoardGames/VG_Gaming').getValue(6, 1)</defaultValue>
      <description></description>
