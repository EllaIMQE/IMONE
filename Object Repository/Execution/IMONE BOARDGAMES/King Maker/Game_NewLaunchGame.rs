...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>66b2eacb-125c-4683-8ebf-f5c4fd5fc772</elementGuidId>
  ...
  &quot;charset&quot;: &quot;UTF-8&quot;
   ...
   <variables>
      <defaultValue>'IMBG130017'</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_BoardGames/King_Maker').getValue(8, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_BoardGames/King_Maker').getValue(3, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_BoardGames/King_Maker').getValue(6, 1)</defaultValue>
      <description></description>
