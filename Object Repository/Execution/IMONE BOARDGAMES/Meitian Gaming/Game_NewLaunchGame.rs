...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>4c184ade-b993-47c7-b701-273848bd49d0</elementGuidId>
  ...
  &quot;charset&quot;: &quot;UTF-8&quot;
   ...
   <variables>
      <defaultValue>'IMBG40004'</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_BoardGames/Meitian').getValue(8, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_BoardGames/Meitian').getValue(3, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_BoardGames/Meitian').getValue(6, 1)</defaultValue>
      <description></description>
