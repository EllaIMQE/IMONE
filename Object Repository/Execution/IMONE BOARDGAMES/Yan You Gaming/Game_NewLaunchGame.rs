...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>e0e73dcc-0cf2-4503-a2b6-b8ed7949a3d1</elementGuidId>
  ...
  &quot;charset&quot;: &quot;UTF-8&quot;
   ...
   <variables>
      <defaultValue>'IMBG110024'</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_BoardGames/Yan_You').getValue(8, 2)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_BoardGames/Yan_You').getValue(3, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_BoardGames/Yan_You').getValue(6, 1)</defaultValue>
      <description></description>
