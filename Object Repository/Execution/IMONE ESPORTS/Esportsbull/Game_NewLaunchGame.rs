...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>b63af109-e9c0-45ef-bc1f-7f0c392d091b</elementGuidId>
  ...
  &quot;charset&quot;: &quot;UTF-8&quot;
   ...
   <variables>
      <defaultValue>'ESPORTSBULL'</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Esports/Esportsbull').getValue(8, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Esports/Esportsbull').getValue(3, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Esports/Esportsbull').getValue(6, 1)</defaultValue>
      <description></description>
