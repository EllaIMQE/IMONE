...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>d6eec9b6-167c-4fcf-8a4b-3869232e79b4</elementGuidId>
  ...
  &quot;charset&quot;: &quot;UTF-8&quot;
   ...
   <variables>
      <defaultValue>'IMTFG0030'</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Esports/Thunder_Fire').getValue(8, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Esports/Thunder_Fire').getValue(3, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Esports/Thunder_Fire').getValue(6, 1)</defaultValue>
      <description></description>
