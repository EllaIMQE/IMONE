...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>9809e3d3-2500-430a-a674-1caac73a04e5</elementGuidId>
  ...
  &quot;charset&quot;: &quot;UTF-8&quot;
   ...
   <variables>
      <defaultValue>'imlotto40038'</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Lottery/IG_Lottery').getValue(8, 2)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Lottery/IG_Lottery').getValue(3, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Lottery/IG_Lottery').getValue(6, 1)</defaultValue>
      <description></description>
