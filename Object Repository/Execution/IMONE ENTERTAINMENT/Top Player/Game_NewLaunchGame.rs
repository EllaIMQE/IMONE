...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>6fd4b9ba-296b-450a-9613-730623ba113c</elementGuidId>
  ...
  &quot;charset&quot;: &quot;UTF-8&quot;
   ...
   <variables>
      <defaultValue>'ENT_FS_007'</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Entertainment/Top_Player').getValue(8, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Entertainment/Top_Player').getValue(3, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Entertainment/Top_Player').getValue(6, 1)</defaultValue>
      <description></description>
