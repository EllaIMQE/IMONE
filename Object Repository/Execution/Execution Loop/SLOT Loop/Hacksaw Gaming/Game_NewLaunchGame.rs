...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>c282c9cf-1fd9-4c05-a84e-e8bcaffd5d5e</elementGuidId>
  ...
  &quot;charset&quot;: &quot;UTF-8&quot;
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Slot/Hacksaw').getValue(8, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Slot/Hacksaw').getValue(3, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('IMONE/IM_Slot/Hacksaw').getValue(6, 1)</defaultValue>
      <description></description>
